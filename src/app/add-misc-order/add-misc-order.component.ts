...
@Component({
  selector: 'app-add-misc-order',
  templateUrl: './add-misc-order.component.html',
  styleUrls: ['./add-misc-order.component.css'],
})
export class AddMiscOrderComponent implements OnInit {
  public details: any = [];
  public menu: any = [];
  public menuList: any = [];
